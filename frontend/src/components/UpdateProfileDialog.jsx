...
const UpdateProfileDialog = ({ open, setOpen }) => {
    ...
    const changeEventHandler = (e) => {
        ...
        // If the input is for phone number, check if it's numeric
        if (name === "phone_Number" && !/^\d*$/.test(value)) {
            return; // If the value is not numeric, do not update the state
        }
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            console.log(res.data.user); // Ensure `profile.skills` and `profile.resume` are included
